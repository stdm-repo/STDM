...
saveRDS(change_list, file = "Part 1/24_220.rds")
...
saveRDS(change_list, file = "Part 1/24_440.rds")
...
saveRDS(change_list, file = "Part 1/48_220.rds")
...
saveRDS(change_list, file = "Part 1/48_440.rds")

stopCluster(cl)


################# Plot of Figure 1 #######################
change_list1=readRDS("Part 1/24_220.rds")
change_list2=readRDS("Part 1/24_440.rds")
change_list3=readRDS("Part 1/48_220.rds")
change_list4=readRDS("Part 1/48_440.rds")
